    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <form id="form1" name="form1" method="post" action="Topk1.jsp">
            <p align="center">&nbsp;</p>
            <p align="center"><span class="style5">Enter The Count </span>
                <input required="required" name="t14" type="text" value="" size="40" />
                        </p>
            <p align="center">
              <input type="submit" name="Submit2" value="FIND TOP K" />
            </p>
                    </form>
          <p align="center"></p>
        </div>
