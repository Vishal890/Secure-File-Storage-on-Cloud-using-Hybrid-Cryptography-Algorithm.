...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Data Owners  ::</span></h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
          <table width="924" border="1" align="center">
  <tr>
    <td width="241" height="32"><div align="center"><span class="style3">Owner Image </span></div></td>
    <td width="168"><div align="center"><span class="style3">Owner Name </span></div></td>
...
<%
      	...
      	try 
	{
           ...
           String query="select * from ownerreg "; 
