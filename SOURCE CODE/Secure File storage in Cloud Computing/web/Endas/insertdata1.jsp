...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from ownerreg  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="Register1.html">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into ownerreg(name,pass,email,mobile,addr,dob,gender,pin,location,imagess) values(?,?,?,?,?,?,?,?,?,?)");
