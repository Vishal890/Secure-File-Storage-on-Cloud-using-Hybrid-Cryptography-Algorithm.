...
<%@page import="com.key.KeyGenerate"%>
...
st1.executeUpdate("insert into  ed_file values (null,'"+file+"','"+totalTime+"','encryption','waiting','waiting')"); 
	
      		 h1=KeyGenerate.randomAlphaNumeric(35);
...
%>
		  <form action="Upload1" method="post" enctype="multipart/form-data">
            ...
            <tr>
             ...
             <tr>
              <td><span class="style4">Choose Image : </span></td>
              <td><input type="file" id="t4" name="image"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
